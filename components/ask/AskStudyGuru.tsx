...
const AskStudyGuru = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="h1-bold text-dark100_light900">Ask StudyGuru</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <label className="paragraph-semibold text-dark400_light800" htmlFor="studyQuestion">
          Your Question
        </label>
        <Textarea
          id="studyQuestion"
        ...
        >
          {isLoading ? "Thinking..." : "Ask StudyGuru"}
        </Button>
      </form>
      {error && (
